...
import com.maximuslotro.mc.signpic.asm.lib.RefName;
import com.maximuslotro.mc.signpic.asm.lib.VisitorHelper;
...
public class GuiNewChatVisitor extends ClassVisitor {
	private static class InitHookMethodVisitor extends MethodVisitor {
		...
		public void visitInsn(final int opcode) {
			if (opcode==Opcodes.RETURN) {
				/*
				 * 42  aload_0 [this]
				 * 43  new com.maximuslotro.mc.signpic.render.CustomChatRender$PicChatHook [54]
				 * 46  dup
				 * 47  aload_0 [this]
				 * 48  getfield net.minecraft.client.gui.GuiNewChat.field_146253_i : java.util.List [50]
				 * 51  invokespecial com.maximuslotro.mc.signpic.render.CustomChatRender$PicChatHook(java.util.List) [56]
				 * 54  putfield net.minecraft.client.gui.GuiNewChat.hook : com.maximuslotro.mc.signpic.render.CustomChatRender.PicChatHook [59]
				 */
				super.visitVarInsn(Opcodes.ALOAD, 0);
				super.visitTypeInsn(Opcodes.NEW, "com.maximuslotro/mc/signpic/render/CustomChatRender$PicChatHook");
				...
				super.visitMethodInsn(Opcodes.INVOKESPECIAL, "com.maximuslotro/mc/signpic/render/CustomChatRender$PicChatHook", "<init>", DescHelper.toDesc(void.class, "java.util.List"), false);
				super.visitFieldInsn(Opcodes.PUTFIELD, "net/minecraft/client/gui/GuiNewChat", "hook", DescHelper.toDesc("com.maximuslotro.mc.signpic.render.CustomChatRender$PicChatHook"));
			}
	...
	private static class DrawChatHookMethodVisitor extends MethodVisitor {
		...
		public void visitCode() {
			/*
			 * 106  aload_0 [this]
			 * 107  getfield net.minecraft.client.gui.GuiNewChat.hook : com.maximuslotro.mc.signpic.gui.PicChatHook [57]
			 * 110  invokevirtual com.maximuslotro.mc.signpic.gui.PicChatHook.updateLines() : void [128]
			 */
			super.visitVarInsn(Opcodes.ALOAD, 0);
			super.visitFieldInsn(Opcodes.GETFIELD, "net/minecraft/client/gui/GuiNewChat", "hook", DescHelper.toDesc("com.maximuslotro.mc.signpic.render.CustomChatRender$PicChatHook"));
			super.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "com.maximuslotro/mc/signpic/render/CustomChatRender$PicChatHook", "updateLines", DescHelper.toDesc(void.class, new Object[0]), false);
			super.visitCode();
		}
		...
		public void visitMethodInsn(final int opcode, @Nullable final String owner, @Nullable final String name, @Nullable final String desc, final boolean itf) {
			if (name!=null&&desc!=null&&this.matcher.match(name, desc)) {
				 ...
				 * 331  iload 16 [j2]
				 * 333  iload 11 [i2]
				 * 335  invokestatic com.maximuslotro.mc.signpic.gui.PicChatLine.hookDrawStringWithShadow(net.minecraft.client.gui.FontRenderer, java.lang.String, int, int, int, net.minecraft.client.gui.GuiNewChat, net.minecraft.client.gui.ChatLine, int, int) : int [170]
				 */
				super.visitVarInsn(Opcodes.ALOAD, 0);
				super.visitVarInsn(Opcodes.ALOAD, 12);
				super.visitVarInsn(Opcodes.ILOAD, 16);
				super.visitVarInsn(Opcodes.ILOAD, 11);
				super.visitMethodInsn(Opcodes.INVOKESTATIC, "com.maximuslotro/mc/signpic/render/CustomChatRender", "hookDrawStringWithShadow",
	...
	private static class GetChatComponentHookMethodVisitor extends MethodVisitor {
		...
		public void visitTypeInsn(final int opcode, final @Nullable String type) {
			...
			if (opcode==Opcodes.CHECKCAST&&VisitorHelper.getMappedName("net/minecraft/client/gui/ChatLine").equals(type)) {
				 ...
				 * 210  instanceof com.maximuslotro.mc.signpic.gui.PicChatLine [445]
				 * 213  ifeq 244
				 * 216  aload 10 [chatline]
				 * 218  checkcast com.maximuslotro.mc.signpic.gui.PicChatLine [445]
				 * 221  aload_0 [this]
				 * 222  aload_0 [this]
				 ...
				 * 229  iload 6 [l]
				 * 231  invokevirtual com.maximuslotro.mc.signpic.gui.PicChatLine.onClicked(net.minecraft.client.gui.GuiNewChat, net.minecraft.client.gui.FontRenderer, int) : net.minecraft.util.IChatComponent [447]
				 * 234  astore 11 [c]
				 * 236  aload 11 [c]
				 * 238  ifnull 244
				 * 241  aload 11 [c]
				...
				super.visitTypeInsn(Opcodes.INSTANCEOF, "com.maximuslotro/mc/signpic/render/CustomChatRender$PicChatLine");
				final Label l = new Label();
				super.visitJumpInsn(Opcodes.IFEQ, l);
				super.visitVarInsn(Opcodes.ALOAD, 10);
				super.visitTypeInsn(Opcodes.CHECKCAST, "com.maximuslotro/mc/signpic/render/CustomChatRender$PicChatLine");
				super.visitVarInsn(Opcodes.ALOAD, 0);
				super.visitVarInsn(Opcodes.ILOAD, 6);
				super.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "com.maximuslotro/mc/signpic/render/CustomChatRender$PicChatLine", "onClicked", DescHelper.toDesc("net.minecraft.util.IChatComponent", "net.minecraft.client.gui.GuiNewChat", int.class), false);
	...
	public GuiNewChatVisitor(final @Nonnull String obfClassName, final @Nonnull ClassVisitor cv) {
		...
		visitField(Opcodes.ACC_PUBLIC|Opcodes.ACC_FINAL, "hook", DescHelper.toDesc("com.maximuslotro.mc.signpic.render.CustomChatRender$PicChatHook"), null, null);
